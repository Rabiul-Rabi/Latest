...
const Single_Product = () => {
  ...
  const specifications = {
    body: 'Metal and glass build, 150g weight, 7.5mm thickness',
    display: '6.5 inches Super AMOLED, 1080x2340 pixels',
    camera: 'Quad-camera setup: 48MP + 12MP + 8MP + 2MP, 20MP front camera',
      ...
      <div className="producDetails p-10 flex justify-center">
        ...
        <div className="vertical border-l-2 border-slate-500">
          <div className="right-side ml-10 ">
            ...
            <label className="mb-5 mt-5 block text-sm font-medium text-gray-700">Quantity</label>
            <input
              type="number"
              id="quantity"
              name="quantity"
...
<div className="relative overflow-x-auto shadow-md sm:rounded-lg w-1/2 mx-auto">
    <table className="w-full text-lg text-left text-gray-900 dark:text-gray-900">
        <thead className="text-xs text-gray-50 uppercase dark:text-gray-50">
            <tr>
                <th scope="col" className="px-6 py-3 bg-gray-50  dark:bg-gray-500 w-1/3">
                    Type
                </th>
                <th scope="col" className="w-2/3 px-6 py-3 dark:bg-gray-500 text-center">
                    Specification
                </th>
        ...
        <tbody>
            <tr class="border-b border-gray-200 dark:border-gray-700">
                <th scope="row" className="w-1/3 px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                Body:
                </th>
      ...
      <div className="description ml-16 ">
