...
const Single_Product = () => {
  ...
  return (
    <>
      ...
      <hr />
      <div className="specifications ml-96 ">
        <h2 className='font-bold ml-5 text-2xl mt-5'>Specifications</h2>
        <ul className='ml-5 mb-5 mr-10'>
          <li><strong>Body:</strong> {specifications.body}</li> <hr />
          <li><strong>Display:</strong> {specifications.display}</li> <hr />
          <li><strong>Camera:</strong> {specifications.camera}</li> <hr />
          <li><strong>Storage:</strong> {specifications.storage}</li> <hr />
        </ul>
      </div>
      <hr />
